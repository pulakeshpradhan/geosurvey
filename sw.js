...
const SHELL = ['./', './index.html', './icon.svg', './manifest.json', ...['styles.css', 'config.js', 'app.js', 'sav.js', 'exports.js', 'analysis.js', 'pdf.js', 'designer.js', 'stats-worker.js'].map(f => `./${f}?v=${VERSION}`)];
