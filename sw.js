...
const CACHE = 'geosurvey-v1.6.0';
const SHELL = ['./', './index.html', './app.js', './sav.js', './exports.js', './analysis.js', './pdf.js', './designer.js', './stats-worker.js', './styles.css', './icon.svg', './manifest.json'];
